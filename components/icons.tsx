...
export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20" cy="20" r="20" fill="#00A551"/>
    <path d="M15.4648 13.3333L10 18.7981L20 28.7981L30 18.7981L24.5352 13.3333L20 17.8685L15.4648 13.3333Z" fill="white"/>
  </svg>
);
...
export const FurnitureIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 9H4v10h16V9z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 13h16m-8-8v4m-4 4h8" />
    </svg>
);
